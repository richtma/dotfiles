...
#
#
# zshrc file. Last updated, May 13, 2025
#
...
zstyle ':prompt:pure:prompt:*' color blue  # cyan

# #colors for pure prompt
# zstyle ':pure:prompt' color blue
#
# #change git status color
# zstyle ':pure:git' color yellow
#
